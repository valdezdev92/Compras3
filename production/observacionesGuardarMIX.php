...
?>
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 id="partidas">Partidas MIX Sumadas </h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
...
while ($row = $resultado->fetch_assoc()) {
 ...
 print_r ($row.'|');
  ...
  <td class=" ">' . $count++. '</td>
  <td class=" ">' . $objetodelGastoR . '</td>
  <td class=" ">' . $row["Cantidad"][$i]. '</td>
...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="row no-print">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                      <input  class="form-control col-md-7 col-xs-12" type="text" name="Folio"  value="" placeholder="Numero en color rojo en el formato" required>
                      </div>
                      </div>
