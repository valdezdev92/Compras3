...
<form action="crearFormatoEventualidad.php" method="POST" name="EvenForm" >
<div class="row">
                ...
                <div class="x_panel">
                  <div class="row no-print">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <textarea name="ObservacionesEventualidad" class="resizable_textarea form-control" placeholder="Observaciones en el fondo del formato"></textarea>
...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="row no-print">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                      <input list="resultados" class="form-control col-md-7 col-xs-12"  name="Proveedor"  id="busqueda" value="" placeholder="Nombre Proveedor" autocomplete="off" oninput="procesarTexto(this)" required>
