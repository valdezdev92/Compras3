          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Solicitud de Reembolso <small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demoform5" data-parsley-validate class="form-horizontal form-label-left" action="SolReembolsoADM-2.php" method="post" name="EditRequi">
