          ...
          <div class="row">
            ...
            <!-- Walforf Ezample -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Autorización de articulos<small></small></h2>
                 ...
                 while ($row = $resultado->fetch_assoc() )
                  {
                    ...
                    $Observaciones14 =$row['Observaciones14'];
                      ...
                      $ObservacionesLety =$row['ObservacionesLety'];
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Autorizar</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php echo' <a href="CambioEstatus.php?Folio='.$Folio.'&IdRequi='.$IdRequi.'&Accion=1">  <span style="Font-size:15px;" class="label label-success"><i class="fa fa-check-circle"></i> Autorizar</span>  </a> &nbsp;   | &nbsp;<a href="CambioEstatus.php?Folio='.$Folio.'&IdRequi='.$IdRequi.'&Accion=2">  <span style="Font-size:15px;" class="label label-danger"><i class="fa fa-close"></i> No Autorizar </span>  </a>' ?>
                    </div>
                  </div>
...
<?php echo '<option value="'.$IdUnidad.'">'.$IdUnidad.'  - SELECCIONADO</option>'; ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control"  name="Fecha" id="Fecha" required="required"  readonly="readonly"  value="<?php echo $Fecha;?> " >
...
<form class="" action="ComentariosLety.php" method="post">
   ...
   <table id="datatable-buttons" class="table table-striped table-bordered">
     ...
     <tr>
       <td class=" ">
         <div class="form-group">
           <label class="control-label col-md-2 col-sm-2 col-xs-12">Observaciones Sec. Administrativa <span class="required">*</span>
           </label>
           <div class="col-md-9 col-sm-9 col-xs-12">
             <!-- <textarea class="form-control" rows="3" placeholder='rows="3"' name="ObservacionesLety"> <?php echo $ObservacionesLety; ?></textarea> -->
           </div>
         </div>

         <input type="text" name="Folio" value="<?php echo $Folio ?>" style="display:none;">
         <input type="text" name="IdRequi" value="<?php echo $IdRequi ?>" style="display:none;">


         </td>
       <!-- <td> <input type="submit" name="" class="btn btn-danger btn-lg" value="No Autorizar"> </td> -->
     </tr>
     <tbody>
