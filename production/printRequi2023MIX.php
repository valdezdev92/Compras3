                        ...
                        <div class="col-xs-12 table paddingTable">
                          ...
                          while ($row = $resultado->fetch_assoc()) {
                              ...
                              echo '
                                      ...
                                      <td class="small">' . $row["idObjetoGasto"] . '</td>
