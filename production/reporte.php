...
$dia = strftime("%d");
          ...
          ?>
  		  ...
  		  <tr class="row6">
  			<td class="column0 style74 s style75" colspan="2">REQUISICIÓN U.C:  <?php echo $FolioAdqui . ' - ' .$Folio?></td>
      ...
      else
      {
        ...
        $SumatoriaIVArt01PROV03 =  0;
         ...
         ?>
  		  <tr class="row28">
  			...
  			<td class="column3 style38 f"> <?php setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($Subtotal01); ?> </td>
  			<td class="column4 style37 null"></td>
  			<td class="column5 style39 f"> <?php setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($Subtotal02); ?></td>
  			<td class="column6 style40 null"></td>
  			<td class="column7 style39 f"> <?php setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($Subtotal03); ?></td>
  		  </tr>
  		  <tr class="row29">
  			<td class="column0 style1 null"></td>
  			<td class="column1 style20 s">IVA</td>
  			<td class="column2 style41 null"></td>
  			<td class="column3 style42 f"> <?php  setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($IVA01);  ?> </td>
  			<td class="column4 style41 null"></td>
  			<td class="column5 style43 f"> <?php  setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($IVA02);  ?></td>
  			<td class="column6 style44 null"></td>
  			<td class="column7 style43 f"> <?php  setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($IVA03); ?></td>
  		  </tr>
  		  <!-- <tr class="row30">
  			<td class="column0 style1 null"></td>
  		  ...
  		  <tr class="row32">
  			...
  			<td class="column3 style50 f"> <?php $Total01 = ($IVA01 + $Subtotal01); setlocale(LC_MONETARY, 'en_US.UTF-8');  echo formatDollars($Total01); ?></td>
  			<td class="column4 style49 null"></td>
  			<td class="column5 style51 f"> <?php  $Total02 = ($IVA02 + $Subtotal02);setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($Total02); ?></td>
  			<td class="column6 style52 null"></td>
  			<td class="column7 style51 f"> <?php  $Total03 = ($IVA03 + $Subtotal03); setlocale(LC_MONETARY, 'en_US.UTF-8'); echo formatDollars($Total03);?></td>
  		  </tr>
  		  <tr class="row33">
  			<td class="column0 style1 null"></td>
        ...
        <?php
         ...
         ?>
  		  ...
  		  <tr class="row40">
  			<td class="column0 style1 null"></td>
  			<td class="column2 style65 null style67" colspan="6"> <?php echo 'Requi Facultad :'.$Folio ?></td>
  		  </tr>
  		  <tr class="row41">
  			<td class="column0 style1 null"></td>
  		  ...
  		  <tr class="row45">
  			<td class="column0 style1 null"></td>
  			<!-- <td class="column1 style17 s">ELABORÓ</td> -->
  			<td class="column2 style1 null"></td>
  			<!-- <td class="column3 style54 s style54" colspan="4">AUTORIZÓ</td> -->
  			<td class="column7 style1 null"></td>
  		  </tr>
  		  <!-- <tr class="row46">
  			<td class="column0 style1 null"></td>
