...
$correo='';
        ...
        left:20px;
  			...
  			<td class="column4 style9 s style9" colspan="3" style="position: absolute; top:870px; left:380px;">M.I. ADRIÁN ISAAC ORPINEL UREÑA </td>
  			<td class="column4 " colspan="4"  style="position: absolute; top:600px; left: 300px; "> SALDO AL DÍA DE HOY <BR> TOTAL $:</td>
        <td class="column4 " colspan="4"  style="position: absolute; top:700px; left: 300px; "> FAVOR DE ENVIAR LA ORDEN DE COMPRA / ORDEN DE PAGO AL SIGUIENTE CORREO:  <?php echo $correo; ?> </td>
