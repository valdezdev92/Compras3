...
// Requisiciones ingresadas el dia de hoy

 $sql = 'SELECT COUNT(*) As RequisHoy FROM Requi  WHERE Fecha = "'.$hoy.'"  ';
 // echo $sql;
 $resultado = $conexion->query($sql);
 $row = $resultado ->fetch_array(MYSQLI_ASSOC);
 $RequisHoy =  $row['RequisHoy'];

 // Requisiciones Pendinetes de Autorizar

  $sql = 'SELECT COUNT(*) As RequisPendinetes FROM Requi  WHERE Estatus = 0  ';
  // echo $sql;
  $resultado = $conexion->query($sql);
  $row = $resultado ->fetch_array(MYSQLI_ASSOC);
  $RequisPendinetes =  $row['RequisPendinetes'];


  $sql = 'SELECT COUNT(*) As RequisPendinetesCotizar FROM Requi a WHERE Estatus = 1';

  // echo $sql;
  $resultado = $conexion->query($sql);
  $row = $resultado ->fetch_array(MYSQLI_ASSOC);
  $RequisPendinetesCotizar =  $row['RequisPendinetesCotizar'];
          ...
          <div class="">
            <div class="row top_tiles" style="margin: 10px 0;">
              <div class="col-md-3 col-sm-3 col-xs-6 tile">
                <span>Requisiciones ingresadas el dia de hoy</span>
                <h2><?php echo $RequisHoy; ?></h2>
                <span class="sparkline_one" style="height: 160px;">
                      <canvas width="200" height="60" style="display: inline-block; vertical-align: top; width: 94px; height: 30px;"></canvas>
                  </span>
              </div>
              <div class="col-md-3 col-sm-3 col-xs-6 tile">
                <span>Requisiciones Pendinetes de autorizar</span>
                <h2><?php echo $RequisPendinetes; ?></h2>
                <span class="sparkline_one" style="height: 160px;">
                      <canvas width="200" height="60" style="display: inline-block; vertical-align: top; width: 94px; height: 30px;"></canvas>
                  </span>
              </div>
              <div class="col-md-3 col-sm-3 col-xs-6 tile">
                <span>Requisiciones Pendinetes de Cotizar</span>
                <h2><?php echo $RequisPendinetesCotizar; ?></h2>
                <span class="sparkline_one" style="height: 160px;">
                      <canvas width="200" height="60" style="display: inline-block; vertical-align: top; width: 94px; height: 30px;"></canvas>
                  </span>
              </div>
