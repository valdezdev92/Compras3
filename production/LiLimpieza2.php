          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Licitación de Productos de limpieza 2 - 2023<small></small></h2>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="SubCuenta" id="SubCuenta">
                              <option value="9">9 -MATERIAL E INSUMOS DE LIMPIEZA</option>
                          </select>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" ">
                            ...
                            <select class="form-control" name="Descripcion01" style="width:700px" >
                              ...
                              <?php
                              require '../ConexionDB.php';
                              $sql = 'SELECT *  FROM LiArticulosLimp223 ';
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" " > <input readonly type="text" name="Descripcion14" value="MATERIAL DE LICITACIÓN UACH-DA-A040101-2023-P2" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
