  	...
  	<table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
  		...
  		<tbody>
  		  <tr class="row0">
  			...
  			<td class="column1">&nbsp;</td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3" colspan="3" style="    position: absolute; top: 80px; left: 200; color: black;">4400 FACULTAD DE INGENIERÍA</td>
  			<td class="column4">&nbsp;</td>
  			<td class="column5">&nbsp;</td>
  			<td class="column6">&nbsp;</td>
  			<td class="column7">&nbsp;</td>
  		  ...
  		  <tr class="row3">
  			...
  			<td class="column1">&nbsp;</td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3   "  colspan="3" style="    position: absolute; top: 105px; left: 200; color: black;"><?php echo $Departamento ?> </td>
  			<td class="column6">&nbsp;</td>
  			<td class="column7">&nbsp;</td>
  			<td class="column8">&nbsp;</td>
  			<td class="column9">&nbsp;</td>
  		  ...
  		  <tr class="row4">
  			...
  			<td class="column1">&nbsp;</td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 " colspan="2" style="font-size: 8px;  position: absolute; top: 90 px; left: 200; "> <?php echo $Motivos ?> </td>
  			<td class="column5 style3 n" style="    position: absolute; top: 115px; left: 450px; color: black;" ><?php echo $Fondo ?></td>
  			<td class="column6 style3 n" style="    position: absolute; top: 115px; left: 520px; color: black;"><?php echo $Funcion ?></td>
  			<td class="column7 style3 n" style="    position: absolute; top: 115px; left: 570px; color: black;"><?php echo $Programa ?></td>
  			<td class="column8 style3 n" style="    position: absolute; top: 115px; left: 620px; color: black;"><?php echo $UPresupuestal ?></td>
  			<td class="column9 style3 n" style="    position: absolute; top: 115px; left: 690px; color: black;" ><?php echo $Cuenta ?></td>
  		  </tr>


  		  </tr>
  		  <tr class="row7">
  			<td class="column0 style0 n"><?php echo $SubCuenta01 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad01 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad01 == 0 ) { } else {  echo $Unidad01; } ?></td>
  			<td class="column4  " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion01 ?></td>
  		  </tr>
  		  <tr class="row8">
  			<td class="column0 style0 n"><?php echo $SubCuenta02 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad02 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad02 == 0 ) { } else {  echo $Unidad02; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion02 ?></td>
  		  </tr>
  		  <tr class="row9">
  			<td class="column0 style0 n"><?php echo $SubCuenta03 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad03 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad03 == 0 ) { } else {  echo $Unidad03; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion03 ?></td>
  		  </tr>
  		  <tr class="row10">
  			<td class="column0 style0 n"><?php echo $SubCuenta04 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad04 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad04 == 0 ) { } else {  echo $Unidad04; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion04 ?></td>
  		  </tr>
  		  <tr class="row11">
  			<td class="column0 style0 n"><?php echo $SubCuenta05 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad05 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad05 == 0 ) { } else {  echo $Unidad05; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion05 ?></td>
  		  </tr>
  		  <tr class="row12">
  			<td class="column0 style0 n"><?php echo $SubCuenta06 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad06 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad06 == 0 ) { } else {  echo $Unidad06; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion06 ?></td>
  		  </tr>
  		  <tr class="row13">
  			<td class="column0 style0 n"><?php echo $SubCuenta07 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad07 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad07 == 0 ) { } else {  echo $Unidad07; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion07 ?></td>
  		  </tr>
  		  <tr class="row14">
  			<td class="column0 style0 n"><?php echo $SubCuenta08 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad08 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad08 == 0 ) { } else {  echo $Unidad08; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion08 ?></td>
  		  </tr>
  		  <tr class="row15">
  			<td class="column0 style0 n"><?php echo $SubCuenta09 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad09 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad09 == 0 ) { } else {  echo $Unidad09; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion09 ?></td>
  		  </tr>
  		  <tr class="row16">
  			<td class="column0 style0 n"><?php echo $SubCuenta10 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad10 ?></td>
  			<td class="column2">&nbsp;</td>
  			<td class="column3 style1 s"><?php  If($Cantidad10 == 0 ) { } else {  echo $Unidad10; } ?></td>
  			<td class="column4 " colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $Descripcion10 ?></td>
  		  </tr>
  		  <tr class="row17">
  			<td class="column0 style0 n"><?php echo $SubCuenta11 ?></td>
  			<td class="column1 style2 n"><?php echo $Cantidad11 ?></td>
  			<td class="column2">&nbsp;</td>
        ...
        switch ($NombreUsuario) {
         ...
         ?>
  			...
  			<td class="column3 style9 s style9"  style=" position: absolute; top: 405px;  left: 230px; "colspan="3"><?php echo $NombreRealizo; ?>   </td>





  			<td class="column4 style9 s style9" colspan="3" style="position: absolute; top:405px; left:380px;">M.I. FABIÁN VINICIO HERNÁNDEZ MARTÍNEZ </td>
  			<td class="column7 style9 s style9" colspan="4"  style="position: absolute; top:405px; left: 555px; ">M.I. FABIÁN VINICIO HERNÁNDEZ MARTÍNEZ </td>
