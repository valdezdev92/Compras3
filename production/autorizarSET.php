...
if ($opc == 1) {
      ...
      if ($conexion->connect_error) {
            ...
            if ($conexion->query($sql) )
            {
                  ...
                  $sqlRev = "SELECT *, b.Cantidad AS CantidadProducto FROM Requisiciones2023 a INNER JOIN movdRequisiciones2023 b on a.idRequisiciones2023 = b.idRequisiciones2023 INNER JOIN catcUnidadesMedida c on b.idcatcUnidadesMedida = c.idcatcUnidadesMedida INNER JOIN catcProductos d on b.idProducto = d.idProducto WHERE a.idRequisiciones2023 = $id and b.idRecibido = 1";
              ...
              // echo 'var Count ='.$row2.'';
                ...
                if ($row2 == 0) 
                {
                  ...
                  //echo"correcto";
                  header('Location: pendienteAutorizar.php#example');
                }else {
        ...
        if ($conexion->query($sql) )
        {
         ...
         //  echo 'var Count ='.$row2.'';
            ...
            if ($row2 == 0) 
            {
              ...
              //echo"correcto";
              header('Location: pendienteAutorizar.php#example2');
            }else {
              header('Location: pendienteAutorizar.php');
            }
  ...
  //  header('Location: ../Mensajes.php?Accion=Error&Mensaje=No se inserto');
    ...
    if ($conexion->connect_error) {
          ...
          if ($conexion->query($sql) )
          {
               ...
               // header('Location: pendienteAutorizar.php');
               echo "error en la insercion de modificar";
              }
 }
