          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Licitación de Papeleria PT-1 2023<small></small></h2>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" ">
                            ...
                            <select class="form-control" name="Descripcion01" style="width:700px" >
                              ...
                              <?php
                              require '../ConexionDB.php';
                              $sql = 'SELECT *  FROM LiPapeleria123 ';
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" " > <input readonly type="text" name="Descripcion14" value="MATERIAL DE LICITACIÓN UACH-DA-A110101-2023-P1" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
