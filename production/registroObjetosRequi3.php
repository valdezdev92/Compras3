...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="row no-print">
                        <div class="col-xs-12">
                        <a href="ReporteADQset.php?id=<?php echo $id?>"> <button class="btn btn-primary btn-block btn-lg" style="margin-right: 5px;" id="next"><i class="fa fa-download"></i> SIGUIENTE</button></a>
                        </div>
                      </div>
