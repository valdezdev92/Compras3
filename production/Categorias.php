...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form id="demo-form5" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="addCategoria.php">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nombre Categoria <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="Categoria">
                        </div>
                      </div>
                      ...
                      <table id="data_table" class="table table-striped ">
                        <thead>
                          ...
                          <th class="column-title" style="display: table-cell;">No. </th>
                            ...
                            <th class="column-title" style="display: table-cell;">idcatCategorias </th>
                            <th class="column-title" style="display: table-cell;">DescripcionCategoria </th>
...
$sql = "SELECT * FROM catCategorias ORDER BY DescripcionCategoria";
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $Count++;
        ...
        echo '
                          ...
                          <tr class="" id="' . $row["idcatCategorias"] . '">
                          <td class=" ">' . $row["idcatCategorias"] . '</td>
                          <td class=" ">' . $row["idcatCategorias"] . '</td>
                          <td class=" ">' . $row["DescripcionCategoria"] . '</td>
                          <td class=" ">' . $row["Estatus"] . '</td>
                          <td class=" "> <a class="btn btn-danger btn-sm" href="DelCategoria.php?idmovd=' . $row["idcatCategorias"] . '&id=' . $id . '"> Eliminar</a></td>
...
<!-- ultima parte para guardar  END-->
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        columns: {
          identifier: [0, 'id'],
          editable: [[1, 'idcatCategorias'], [2, 'DescripcionCategoria'], [3, 'Estatus']]
        },
        hideIdentifier: true,
        url: 'editarCelda3.php'
    });
