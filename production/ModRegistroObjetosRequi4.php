...
<script>
  ...
  <body class="nav-md">
    ...
    <p style="font-size:20px;"><b> Modificando requisición del usuario ADMINISTRADOR</b></p>
</div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demoform2" data-parsley-validate class="form-horizontal form-label-left" action="UpdateAltaRequi4.php" method="post" name="demoform2">
...
$nombreUsuarioSolicitante = $row['PrimerNombre'].' '.$row['PrimerApellido'];

$UnidadPresupuestalOriginal = $row['Centro'];

$idUsuarioOriginal = $row['IdUsuario'];  


$unidadOriginal = $row['unidadPresupuestal'];
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="DepSolicitante" id="DepSolicitante">
                            <option value="<?php echo $UnidadPresupuestalOriginal; ?>"><?php echo $UnidadPresupuestalOriginal; ?></option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="UnidadPresupuestal" id="UnidadPresupuestal">
                            <option value="<?php echo $unidadOriginal; ?>"><?php echo $unidadOriginal; ?> </option>
                          </select>
                        </div>
                      </div>
 ...
 ?>
              ...
              ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="Solicitante" required="required" class="form-control col-md-7 col-xs-12" placeholder="0" name="Solicitante" value="<?php echo $nombreUsuarioSolicitante; ?>" onkeyup="mayus(this);"
                      ...
                      <input type="text" style ="display:none;" name="Solicitante" value="<?php echo $idUsuarioOriginal?>">
