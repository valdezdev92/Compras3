                 ...
                 while ($row = $resultado->fetch_assoc() )
                  ...
                  <?php
                      ...
                      if ($Estatus == 2)
                      {
                              ...
                              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <p style="font-size:20px; color:white;">Requi No.'.$Folio.' La Requisición no fue Autorizada por :</p>
                              <p style="font-size: 24px; color:white;">'.$ObservacionesLety.'</p>
...
<?php echo '<option value="'.$IdUnidad.'">'.$IdUnidad.'  - SELECCIONADO</option>'; ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="Motivos" required="required" class="form-control col-md-7 col-xs-12" placeholder="Motivos requisición..." name="Motivos" readonly="readonly" value="<?php echo $Motivos;?>" onkeyup="mayus(this);" onkeypress="return validarLetras(event)">
                          ...
                          <div class="x_content">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                              <thead>
                                ...
                                <th class="column-title">Observaciones Generales </th>
