...
// echo $Centro;  //Centro y descripcion
 ...
 ?>
                          ...
                          $d = $hoy['mday'];
                            ...
                            ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="text" id="Motivos" required="required" class="form-control col-md-7 col-xs-12" placeholder="Motivos requisicion..." name="Motivos" value="<?php echo $Motivos; ?>" onkeyup=" " onkeypress="return validarLetras(event)" -->
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">
                              ...
                              <select style="width:160px" class="form-control" name="Unidad01">
                                    ...
                                    <option value="PIEZA">PIEZA</option><option value="PAQUETE">PAQUETE</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion01" value="<?php echo $Descripcion01 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones01" value="<?php echo $Observaciones01 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
      ...
      <option value="SERVICIO">SERVICIO</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion02" value="<?php echo $Descripcion02 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones02" value="<?php echo $Observaciones02 ?>" style="display: none;" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
      ...
      <option value="SERVICIO">SERVICIO</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion03" value="<?php echo $Descripcion03 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones03" value="<?php echo $Observaciones03 ?> " onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
          ...
          <option value="SERVICIO">SERVICIO</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion04" value="<?php echo $Descripcion04 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones04" value="<?php echo $Observaciones04 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
              ...
              <option value="SERVICIO">SERVICIO</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion05" value="<?php echo $Descripcion05 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones05" value="<?php echo $Observaciones05 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                ...
                <option value="SERVICIO">SERVICIO</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion06" value="<?php echo $Descripcion06 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones06" value="<?php echo $Observaciones06 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
          ...
          <option value="SERVICIO">SERVICIO</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion07" value="<?php echo $Descripcion07 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones07" value="<?php echo $Observaciones07 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                          ...
                          <option value="SERVICIO">SERVICIO</option>
                            ...
                            <td class=" "> <input type="text" name="Descripcion08" value="<?php echo $Descripcion08 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones08" value="<?php echo $Observaciones08 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" "> <input type="text" name="Descripcion09" value="<?php echo $Descripcion09 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones09" value="<?php echo $Observaciones09 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" "> <input type="text" name="Descripcion10" value="<?php echo $Descripcion10 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones10" value="<?php echo $Observaciones10 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" "> <input type="text" name="Descripcion11" value="<?php echo $Descripcion11 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones11" value="<?php echo $Observaciones11 ?>" onkeyup=" " style="display:none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" "> <input type="text" name="Descripcion12" value="<?php echo $Descripcion12 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones12" value="<?php echo $Observaciones12 ?>" onkeyup=" " style="display:none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" "> <input type="text" name="Descripcion13" value="<?php echo $Descripcion13 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones13" value="<?php echo $Observaciones13 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" "> <input type="text" name="Descripcion14" value="<?php echo $Descripcion14 ?>" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            <td class=" "> <input type="text" name="Observaciones14" value="<?php echo $Observaciones14 ?>" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" --> </td>
                            </td>
                          </tr>
                            ...
                            <td class=" ">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-11 col-sm-11 col-xs-11">
                                  <textarea class="form-control" rows="5" placeholder='Favor de colocar toda la información necesaria para su requisición.' name="Observaciones01" maxlength="1100"><?php echo $Observaciones01 ?></textarea>
                                </div>
                              </div>
