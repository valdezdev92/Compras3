          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Licitación de Papel<small></small></h2>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="SubCuenta" id="SubCuenta">
                              <option value="1">1 -PAPELERIA Y UTILES DE ESCRITORIO</option>
                          </select>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;">5</td>
                          <td class=" "style="display: none;"> <input disabled type="text" name="Cantidad05" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" "style="display: none;">


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad05" disabled>
                          ...
                          <td class=" "style="display: none;"> <input disabled type="text" name="Descripcion05" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;"> <input type="text" name="Observaciones05" value="" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;">6</td>
                          <td class=" "style="display: none;"> <input disabled type="text" name="Cantidad06" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" "style="display: none;">


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad06" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" "style="display: none;"> <input readonly type="text" name="Descripcion06" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;"> <input type="text" name="Observaciones06" value="" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" " style="display: none;" >7</td>
                          <td class=" " style="display: none;" > <input disabled type="text" name="Cantidad07" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" " style="display: none;" >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad07" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" " style="display: none;" > <input disabled type="text" name="Descripcion07" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" " style="display: none;" > <input type="text" name="Observaciones07" value="" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;" >8</td>
                          <td class=" "style="display: none;" > <input disabled type="text" name="Cantidad08" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" "style="display: none;" >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad08" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" "style="display: none;" > <input disabled type="text" name="Descripcion08" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;" > <input type="text" name="Observaciones08" value="" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;" >9</td>
                          <td class=" "style="display: none;" > <input disabled type="text" name="Cantidad09" value="" onkeypress="return valida(event)"> </td>
                          <td class=" "style="display: none;" >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad09" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" "style="display: none;" > <input disabled type="text" name="Descripcion09" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;" > <input type="text" name="Observaciones09" value="" onkeyup=" " style="display: none;" onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;" >10</td>
                          <td class=" "style="display: none;" > <input disabled type="text" name="Cantidad10" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" "style="display: none;" >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad10" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" "style="display: none;" > <input disabled type="text" name="Descripcion10" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;" > <input type="text" name="Observaciones10" value="" style="display: none;" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;" >11</td>
                          <td class=" "style="display: none;" > <input disabled type="text" name="Cantidad11" value="" onkeypress="return valida(event)"> </td>
                          <td class=" "style="display: none;" >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad11" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" "style="display: none;" > <input disabled type="text" name="Descripcion11" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;" > <input type="text" name="Observaciones11" value="" style="display: none;" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;" >12</td>
                          <td class=" "style="display: none;" > <input disabled type="text" name="Cantidad12" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" "style="display: none;" >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad12" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" "style="display: none;" > <input disabled type="text" name="Descripcion12" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;" > <input type="text" name="Observaciones12" value="" style="display: none;" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" "style="display: none;" >13</td>
                          <td class=" "style="display: none;" > <input disabled type="text" name="Cantidad13" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" "style="display: none;" >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)">  -->
                            <select style="width:160px" class="form-control" name="Unidad13" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" "style="display: none;" > <input disabled type="text" name="Descripcion13" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          <td class=" "style="display: none;" > <input type="text" name="Observaciones13" style="display: none;" value="" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
                          </td>
                        </tr>
                        ...
                        <tr class="odd pointer">
                          ...
                          <td class=" " >14</td>
                          <td class=" " > <input disabled type="text" name="Cantidad14" value="" onkeypress="return valida(event)" onpaste="return true"> </td>
                          <td class=" " >


                            <!-- <input type="text" name="Unidad01" value="" onkeyup=" " onkeypress="return validarLetras(event)"> -->
                            <select style="width:160px" class="form-control" name="Unidad14" disabled>
                              <option value="PIEZA">PIEZA</option>
                              <option value="PAQUETE">PAQUETE</option>
                              <option value="CAJA">CAJA</option>
                              <option value="CENTIMETROS">CENTIMETROS</option>
                          ...
                          <td class=" " > <input readonly type="text" name="Descripcion14" value="MATERIAL DE LICITACIÓN UACH-DA-A030301-2022-P" onkeyup=" " onkeypress="return validarLetras(event)" style="width:700px" onpaste="return true" maxlength="120"> </td>
